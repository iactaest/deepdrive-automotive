...
export default function ProfiloShow({ profilo }: any) {
    ...
    // Card sezione principale - affiancata a 2 colonne
    const SectionCard = ({ icon: Icon, title, children, color = 'blue', fullWidth = false }: any) => (
        <div className={`bg-slate-800/50 rounded-xl p-4 border border-slate-700/50 ${fullWidth ? 'col-span-2' : ''}`}>
            <h2 className="text-sm font-semibold text-white mb-2.5 flex items-center gap-2">
                <Icon className={`h-4 w-4 text-${color}-400`} /> {title}
            </h2>
            ...
            <div className="py-6">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <SectionCard icon={Building2} title="Dati Anagrafici" color="blue">
                        ...
                        <SectionCard icon={Phone} title="Dati di Contatto" color="green">
                        ...
                        <SectionCard icon={MapPin} title="Localizzazione" color="orange">
                        ...
                        <SectionCard icon={Award} title="Caratteristiche Ente" color="purple">
                        ...
                        <SectionCard icon={Heart} title="Preferenze Bandi" color="pink">
                        ...
                        {/* ========== STEP 6A - Capacità Progettuale ========== */}
                        <SectionCard icon={Target} title="Capacità Progettuale" color="cyan">
                        ...
                        {/* ========== STEP 6B - STEP Bando FESR ========== */}
                        <SectionCard icon={Shield} title="STEP - Bando FESR" color="yellow">
                        ...
                        {/* ========== STEP 6C - GOL/PNRR ========== */}
                        <SectionCard icon={Users} title="GOL / PNRR" color="blue">
                    ...
                    <div className="mt-6 bg-green-500/10 rounded-xl p-4 border border-green-500/20 flex items-center gap-3">
                        <CheckCircle className="h-5 w-5 text-green-400" />
                        <p className="text-green-400">{profilo.profilo_completo ? '✅ Profilo completo!' : '⚠️ Profilo non ancora completo'}</p>
                    </div>
                </div>
            </div>
        </LayoutEnte>
