...
export default function ListaBandiContenuto({ bandi, stats, categorie, regioni, filtri, compatto = false, onFiltra }: Props) {
    ...
    const casellaFiltro = (label: string, count: number, bordo: string, attivo: boolean, onClick: () => void) => (
        <button
            onClick={onClick}
            className={`card-bolla flex-1 text-left p-4 transition-all hover:brightness-125 ${attivo ? 'brightness-125' : ''}`}
    ...
    return (
        <>
            ...
            <div className={`flex gap-3 mb-8 ${compatto ? 'flex-col' : 'flex-wrap'}`}>
            ...
            <div className="bg-slate-800/50 rounded-xl px-3 py-2 border border-slate-700/50 mb-6">
                <div className={`flex items-center gap-1.5 ${compatto ? 'flex-col items-stretch' : 'flex-wrap'}`}>
                    ...
                    <div className={`flex-1 min-w-[120px] ${compatto ? '' : 'max-w-[160px]'}`}>
                    ...
                    <div className={`flex-1 min-w-[120px] ${compatto ? '' : 'max-w-[150px]'}`}>
                    ...
                    <div className={`flex-1 min-w-[100px] ${compatto ? '' : 'max-w-[130px]'}`}>
                    ...
                    <div className={`flex-1 min-w-[110px] ${compatto ? '' : 'max-w-[140px]'}`}>
