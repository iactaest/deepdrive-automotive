...
// incorporato in DashboardMobile (griglie a colonna singola in compatto).
export default function StoricoBandiContenuto({ stats, bandiVinti, bandiPersi, compatto = false }: Props) {
